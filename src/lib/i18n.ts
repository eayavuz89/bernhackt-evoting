...
const de: Dict = {
  ...
  scanQrBtn: "QR-Code auf dem Ausweis scannen",
  scanQrTitle: "QR-Code scannen",
  scanQrHint: "Halten Sie den QR-Code Ihres Stimmrechtsausweises vor die Kamera.",
  scanQrDenied: "Kamerazugriff wurde verweigert. Bitte erlauben Sie den Zugriff in den Browser-Einstellungen.",
  scanQrError: "Die Kamera konnte nicht gestartet werden.",
  scanQrSuccess: "Code erkannt und übernommen.",
...
const en: Dict = {
  ...
  scanQrBtn: "Scan the QR code on the card",
  scanQrTitle: "Scan QR code",
  scanQrHint: "Hold the QR code of your voting card in front of the camera.",
  scanQrDenied: "Camera access was denied. Please allow access in your browser settings.",
  scanQrError: "The camera could not be started.",
  scanQrSuccess: "Code recognised and filled in.",
...
const fr: Dict = {
  ...
  scanQrBtn: "Scanner le code QR de la carte",
  scanQrTitle: "Scanner le code QR",
  scanQrHint: "Tenez le code QR de votre carte de vote devant la caméra.",
  scanQrDenied: "L'accès à la caméra a été refusé. Veuillez l'autoriser dans les réglages du navigateur.",
  scanQrError: "La caméra n'a pas pu être démarrée.",
  scanQrSuccess: "Code reconnu et rempli.",
...
const it: Dict = {
  ...
  scanQrBtn: "Scansionare il codice QR sulla carta",
  scanQrTitle: "Scansionare il codice QR",
  scanQrHint: "Tenga il codice QR della sua carta di voto davanti alla fotocamera.",
  scanQrDenied: "L'accesso alla fotocamera è stato negato. Lo consenta nelle impostazioni del browser.",
  scanQrError: "Impossibile avviare la fotocamera.",
  scanQrSuccess: "Codice riconosciuto e inserito.",
